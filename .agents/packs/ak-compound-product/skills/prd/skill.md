---
id: prd
name: PRD Generator (Autonomous)
version: 1.0.0
description: |
  Generate a Product Requirements Document (PRD) for a new feature autonomously.
  ...
  Note: This skill self-clarifies rather than asking the user questions.
tags: [compound-product, planning, prd, autonomous]
inputs:
  - name: feature
    type: string
    required: true
...
constraints:
  - Must self-clarify (answer your own questions)
  - Do NOT ask the user questions
  - Tasks must be small and specific
  - Acceptance criteria must be verifiable
---

# PRD Generator (Autonomous)
