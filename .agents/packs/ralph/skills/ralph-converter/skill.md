...
description: |
  ...
  Use when you have an existing PRD and need to convert it to Ralph's JSON format.
  Triggers on: convert this prd, turn this into ralph format, create prd.json from this, ralph json.
tags: [ralph, automation, prd]
inputs:
  - name: prd
    type: markdown
    required: true
    description: The PRD document to convert
  - name: project_name
    type: string
    required: false
    description: Override project name (defaults to extraction from PRD)
outputs:
  - name: prd_json
    type: json
    description: Ralph-compatible prd.json file
constraints:
  ...
  - UI stories must include browser verification criterion
---
